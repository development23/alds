            ...
            >
              ...
              >
                ...
                <li className={styles.dropdown}>
                  ...
                  <div className={`${styles.dropdowncontent} ${styles.whydropdowncontent} `}>
                    <div
                    ...
                    >
                      <div className="md:w-1/2 overflow-hidden">
                        <ul className={styles.bottomside}>
                          ...
                          <li  className={`${styles.subdropdown} border-b hover:bg-gray-100`}>
                              <a>                               
                                <span> Resources </span>
                                <ArrowRightIcon />
                              </a>
                              <div className={`${styles.subdropdowncontent} ${styles.whysubdropdowncontent} `}>
                                <div
                                ...
                                >
                                  <div className="w-full overflow-hidden">
                                    <ul className={styles.bottomside}>
                                      ...
                                      <li  className={`${styles.dropdown} border-b hover:bg-gray-100`}>
                                        <Link href="/">
                                          <a>                               
                                            <span> Blogs </span>
                                          </a>
