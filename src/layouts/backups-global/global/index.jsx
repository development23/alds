            ...
            <div className="lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full  flex flex-col lg:h-auto">
              ...
              <Link href="#">
                <div className="border-b px-2 py-1">
                  ...
                  >
                    Services <ArrowDownIcon className="right-0 absolute" />
                    <div
                      className={`${styles.mobiledropdowncontent}`}
                      onClick={() => setActive(false)}
                    >
                      <Link href="/cross-platform-app-development">
                        <a>Cross Platform App Development</a>
                      </Link>
                      <Link href="/customized-app-development">
                        <a>Customized Application Development</a>
                      </Link>
              ...
              <Link href="#">
                <div className="border-b px-2 py-1">
                  <a
                    className={`lg:inline-flex lg:w-auto w-full rounded font-bold ${styles.mobiledropdown}`}
                  >
                    Technologies <ArrowDownIcon className="right-0 absolute" />
                    <div
                      className={`${styles.mobiledropdowncontent}`}
                      onClick={() => setActive(false)}
                    >
                      <Link href="/">
                        <a>iOS App Development</a>
                      </Link>
                      <Link href="/">
                      ...
                      <Link href="/">
                        <a>React Native App Development</a>
                      </Link>
                      ...
                      <Link href="/">
                        <a> Native Application Development</a>
                      </Link>
