    ...
    <div>
      ...
      >
        ...
        <div className={`  ${styles.btp} w-full overflow-hidden    xl:w-4/5 `}>
          <Image
            src={require("@/assets/images/blogs/banner/blog2.jpg")}
            alt="Aladinn Tech"
          />
        </div>
      </div>
        ...
        <div className="md:px-28 md:pt-10 ">
          <div className="flex flex-wrap md:px-38  overflow-hidden ">
            ...
            >
              ...
              <p>
                {" "}
                Android is a very famous computing platform that has first been introduced in the commercial market back in 2008 when people prevalently knew only about Blackberry and Nokia. In that era, iPhones were beginning to make their way into the market and most phone users were using flip phones to tap and send their messages. Back at that time, android technology was first introduced in the market. Now, about 70% of devices used worldwide run on android and are a preferred choice for app development. If you are planning to develop your android app for your business, you better consult the <a target="_blank" rel="noopener noreferrer" href="https://www.aladinntech.com/"><b>best android development company in Jaipur</b></a> that offers comprehensive development and management of your application, from conceptualizing to the app launch. ALDS, the <a target="_blank" rel="noopener noreferrer" href="https://www.aladinntech.com/"><b>best android development company in Jaipur</b></a> will take care of developing, managing, and adding new features to your android application. 
              </p>
              <p>
                {" "}
            ...
            >
              ...
              <div className={` ${styles.titlesubcontainer} `}>
                <p className={` ${styles.titlesub} `}> Native and Cross-Platform App Development  </p>
              </div>
              <p>
              ...
              <div className={` ${styles.titlesubcontainer} `}>
                <p className={` ${styles.titlesub} `}> Integration  </p>
              </div>
              <p>
                {" "}
              ...
              <p>
                {" "}
                As the <a target="_blank" rel="noopener noreferrer" href="https://www.aladinntech.com/"><b>best android development company in Jaipur</b></a>, we offer management services by keeping check of the functions of the developed software through maintenance and support services. 
              </p>
              <p>
                <b>
              ...
              <div className={` ${styles.titlesubcontainer} `}>
                <p className={` ${styles.titlesub} `}>Open Source </p>
              </div>
              <p>
              ...
              <div className={` ${styles.titlesubcontainer} `}>
                <p className={` ${styles.titlesub} `}> Pro-active Testing</p>
              </div>
              <p>
                {" "}
              ...
              <div className={` ${styles.titlesubcontainer} `}>
                <p className={` ${styles.titlesub} `}> On-time Delivery </p>
              </div>
              <p>
              ...
              <div className={` ${styles.titlesubcontainer} `}>
                <p className={` ${styles.titlesub} `}> Transparency Through The Process</p>
              </div>
              <p>
              ...
              <div className={` ${styles.titlesubcontainer} `}>
                <p className={` ${styles.titlesub} `}> Skilled Team of ALDS </p>
              </div>
              <p>
              ...
              <div className={` ${styles.titlesubcontainer} `}>
                <p className={` ${styles.titlesub} `}> Prompt Technical Support </p>
              </div>
              <p>
              ...
              <p>
              ALDS, the <a target="_blank" rel="noopener noreferrer" href="https://www.aladinntech.com/"><b>best android development company</b></a> in Jaipur is here for you. Our state-of-the-art specialised technological services will raise your business to new heights. 
              </p>
            </div>
          </div>
        </div>
