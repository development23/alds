        ...
        >
          ...
          <div className="flex flex-wrap overflow-hidden ">
            {ourvalues.map((item, index) => (
              ...
              >
                <div
                  className={`w-full overflow-hidden ${styles.singleservices} `}>
                ...
                <div className={` ${styles.innerpagecon}`}>
                  <div className="flex items-center text-left md:text-right overflow-hidden">
                    <div className={`overflow-hidden    md:w-4/5 `}>
                      ...
                      We realign your budget with IT initiatives, ideate and formulate the best strategies to move your business forward.
                      </p>
                    </div>
                    <div
                ...
                <div className={` ${styles.innerpagecon}`}>
                  <div className="flex items-center overflow-hidden">
                    ...
                    >
                      ...
                      <p className={` ${styles.paragraph} `}>
                      We deliver an immersive experience for users with creative designs, compelling content and intuitive navigation.
                      </p>
                    </div>
                    <div
                      className={` ${styles.bglightgray} bg-opacity-25 overflow-hidden text-center md:w-1/5 md:ml-4`}
                ...
                <div className={` ${styles.innerpagecon}`}>
                  <div className="flex items-center  text-left md:text-right  overflow-hidden">
                    <div className={`overflow-hidden md:w-4/5 `}>
                      ...
                      <p className={` ${styles.paragraph} `}>
                      ALDS is committed to delivering results beyond expectations by keeping pace with ever-evolving technology.
                      </p>
                    </div>
                    <div
                      className={` ${styles.bglightgray} bg-opacity-25 overflow-hidden text-center md:w-1/5 md:ml-4`}
                ...
                <div className={` ${styles.innerpagecon}`}>
                  <div className="flex items-center overflow-hidden">
                    ...
                    <div className={`overflow-hidden md:w-4/5 `}>
                      ...
                      <p className={` ${styles.paragraph} `}>
                      We develop high-end, technically advanced solutions using the latest software and technology platforms to give you long-term utility.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className={` ${styles.innerpagecon}`}>
                  <div className="flex items-center overflow-hidden">
                    ...
                    <div className={`overflow-hidden md:w-4/5 `}>
                      ...
                      <p className={` ${styles.paragraph} `}>
                      The deployment of an application or a website requires a plan, schedule, and control of how releases are moved to test and live environments.
                      </p>
                    </div>
                  </div>
                </div>
