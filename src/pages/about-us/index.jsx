            ...
            <div className="flex flex-wrap overflow-hidden ">
              ...
              >
                ...
                <p>
                  ...
                  effectively. Performance Tracking is done on a daily, weekly,
                  and monthly basis to ensure tasks planned are done as per the
            ...
            <div className="flex flex-wrap items-center overflow-hidden ">
              ...
              >
                <div className={` ${styles.titlesubcontainer} `}>
                  ...
                  <h2 className={` ${styles.titlesubmain} `}>Core Value </h2>
                </div>
                <p>
                  Performance Tracking is done on a daily, weekly, and monthly
                  basis to ensure tasks planned are done as per the schedule and
